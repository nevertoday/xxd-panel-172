---
name: xxd-panel-172
description: "Create Panel 172 raster artwork: Centred Subject with Translucent Geometry. Use when the user invokes xxd-panel-172 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-172/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-172-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
