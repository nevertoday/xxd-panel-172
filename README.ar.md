...
# XXD Panel 172｜موضوع مركزي وطبقات هندسية شفافة
...
موضوع صغير في المركز وطبقات هندسية شفافة باهتة تظل خلفية ثانوية ولا تصنع مركزاً بصرياً ثانياً.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 172 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-172`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-172 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-172-prompt.en.md) أو [بالصينية](references/xxd-panel-172-prompt.zh-CN.md).
