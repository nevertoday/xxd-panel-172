...
# XXD Panel 172｜Centred Subject with Translucent Geometry
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 172 Sample 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 172 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 172 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 172 Sample 8"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 172 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 172 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 172 additional top-bottom sample 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 172 additional top-bottom sample 4"></td>
  </tr>
</table>
...
Require a restrained centred subject and generous clean whitespace. Optional translucent geometric layers must stay soft, light, low-contrast and subordinate, never a second focal point. Sparse thin vertical elements may support the structure. Remix source colours into high-key warm ivory, grey-cyan/green, pale ochre, soft blue/orange with only tiny accents. Avoid heavy geometry, strong gradients and dense decoration.
...
- `design-only`: the full canvas contains only Panel 172's designed translation; the photograph remains a non-visible reference.
...
```bash
git clone https://github.com/nevertoday/xxd-panel-172.git
npx skills add https://github.com/nevertoday/xxd-panel-172 --skill xxd-panel-172
```

Restart the agent session after installation, then invoke `$xxd-panel-172`. Add `--global --agent codex --yes` when a user-level Codex installation is wanted.

Common examples:

```text
/xxd-panel-172 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale en-US
/xxd-panel-172 photo.jpg --mode left-right --size 16:9 --text prompt --locale en-US
/xxd-panel-172 photo.jpg --mode design-only --size 9:16 --text none
/xxd-panel-172 ./photos --mode design-only --size auto,3:4 --text prompt --locale ja-JP
```

See [SKILL.md](SKILL.md) for the full runtime contract and the [English](references/xxd-panel-172-prompt.en.md) or [Chinese](references/xxd-panel-172-prompt.zh-CN.md) runtime adapter.
